...
<!-- Bu sayfada css dosyasındaki body background rengi çalışmadı o yüzden buraya yeniden  ekleme yapıldı -->

    <style>
      body {
         background-color: rgb(173, 249, 224);
      }
    </style>
</head>
<body> 
...
<cfdiv class='navbar_watched_Films'> 
